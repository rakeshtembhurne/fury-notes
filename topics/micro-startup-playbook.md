...
created: 2026-05-21
updated: 2026-05-21
tags: #research #micro-startup #playbook #validated #rocky
source: Synthesized from research_program.md + vault research
---

# Micro-Startup Playbook — Synthesized

> **Purpose:** Consolidated reference for building micro-startups that leverage AI. Synthesized from research_program.md and vault research. Updated May 2026.

---

## The Core Thesis

**Build micro-startups that USE AI. AI is a tool, not the product.**

The successful indie hackers don't sell "AI business agents." They build micro-startups that leverage AI to build faster and operate smarter. AI is the competitive advantage, not the product itself.

---

## Speed-to-Revenue: 5-Day $7K MRR Playbook

| Day | Action |
|-----|--------|
| Day 1 | Validate with 10 customer conversations + pick smallest viable product |
| Day 2-3 | Build in public, tweet daily |
| Day 3 | Launch rough with waitlist |
| Day 4 | Direct outreach to 100 people |
| Day 5 | First revenue |

### Monthly Milestones

| Period | MRR Target | Phase |
|--------|-----------|-------|
| Months 0-3 | $100-1K | First revenue |
| Months 3-6 | $1-10K | PMF signals |
| Months 6-12 | $10-30K | Scale |
| Year 2 | $30-100K | Establish |

---

## Exit Strategy: TrustMRR

**Strategy:** Build to $100 MRR → Sell for $1,000-3,000 (10-30x multiple) → Repeat

### Real Exit Multiples (2025-2026)
...
**Pattern:** Micro SaaS (tools, bots, scrapers) >> Consumer apps. Simple vertical tools sell at 17-33x. Consumer apps sell at 2-3x.

---

## Verified Revenue Data (Real Founders)
...
| Parking app | Parking finder | **$60K MRR** | Boring niche |
| Toll calculator | Toll calc | **$45K MRR** | Boring niche |
| Fuel tracker | Fuel costs | **$50K MRR** | Boring niche |
| Postiz | Open-source SaaS | **$43K MRR** | AGPL-3, fully public |
| Reddit SaaS | Unknown | **$30K MRR** | 4 months, Reddit only |

**Key Pattern:** "Boring" vertical apps >> "sexy" horizontal tools. Find a narrow pain point and own it.
...
**Total fixed cost: ~$1/month** — Use this stack for ALL micro-startups.

---

## Categories: Build Priority
...
3. Use the research system to find gaps in existing markets
...
| Project | URL | Status |
|---------|-----|--------|
| Trigyaa.com | shop.trigyaa.com | LIVE — Women's wear D2C, India |
| KhabarOnline | khabaronline.in | LIVE — needs content |
| JciAlumni.org | jcialumni.org | LIVE — 40K members |
| rakesh.tembhurne.com | rakesh.tembhurne.com | LIVE — personal blog |
...
- [[research_program.md]] — Source of truth for priorities
- [[brandsome-dev-logo-tool]] — Priority #2 product
- [[brandsome-app-social-media-saas]] — Priority #3 product
